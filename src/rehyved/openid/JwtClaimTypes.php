...
class JwtClaimTypes
{
     ...
     */
    const PREFERRED_USER_NAME = "preferred_username";
    ...
    /**
     * End-User's birthday, represented as an ISO 8601:2004 [ISO8601‑2004] YYYY-MM-DD format. The year MAY be 0000, indicating that it is omitted. To represent only the year, YYYY format is allowed. Note that depending on the underlying platform's date related function, providing just year can result in varying month and day, so the implementers need to take this factor into account to correctly process the dates.    const BirthDate = "birthdate";
     * from the time zone database (http://www.twinsun.com/tz/tz-link.htm) representing the End-User's time zone. For example, Europe/Paris or America/Los_Angeles.
     */
    const ZONE_INFO = "zoneinfo";
     ...
     */
    const AUTHENTICATION_METHOD = "amr";
     ...
     */
    const AUTHENTICATION_CONTEXT_CLASS_REFERENCE = "acr";
     ...
     */
    const AUTHENTICATION_TIME = "auth_time";

    /**
     * The party to which the ID Token was issued. If present, it MUST contain the OAuth 2.0 Client ID of this party. This Claim is only needed when the ID Token has a single audience value and that audience is different than the authorized party. It MAY be included even when the authorized party is the same as the sole audience. The azp value is a case sensitive containing a StringOrURI value.
     */
     ...
     */
    const ACCESS_TOKEN_HASH = "at_hash";
     ...
     */
    const AUTHORIZATION_CODE_HASH = "c_hash";
     ...
     */
    const REFERENCE_TOKEN_ID = "reference_token_id";
